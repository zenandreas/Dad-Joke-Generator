...
/* tried making the above into an object, need help!
...
const jokeDisplay = {
  ...
  randomJoke: function() {
    const random = Math.floor(Math.random() * 23);
    document.getElementById("jokeSection").innerHTML = this.jokeList[random];
    document.getElementById("jokeCount").innerHTML = `Joke: ${random + 1} / 24`;
  ...
  setJoke: function() {
    document.getElementById("jokeSection").innerHTML = this.jokeList[this.number];
    return document.getElementById("jokeCount").innerHTML = `Joke: ${this.number + 1} / 24`
  }
};
